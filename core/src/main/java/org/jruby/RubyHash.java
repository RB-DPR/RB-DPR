...
public class RubyHash extends RubyObject implements Map {
    ...
    public static RubyClass createHashClass(Ruby runtime) {
         ...
         */
        // read only methods 
        String[] readOnly = new String[]{"include?", "key?", "has_key?", "member?", 
                "each", "each_pair", "each_key", "each_value", };
        hashc.setCommutative(readOnly, ComTableItem.COM_TABLE_TYPE_BOOL, true, true);
        //add only methods
        String[] addOnly = new String[]{"merge", "store", "[]="};
        hashc.setCommutative(addOnly, ComTableItem.COM_TABLE_TYPE_BOOL, true, true);
        /** End **/
