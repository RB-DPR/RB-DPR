...
import org.jruby.parlib.CoBegin;
...
public class RubyKernel {
     ...
     * DPR added
     */
    @JRubyMethod(name = "co", required = 2, rest = true, module = true)
    public static void coBegin(ThreadContext context, IRubyObject recv,
            IRubyObject[] args) {
        CoBegin.start(context, recv, args);
    }
    /** End **/
    ...
    @JRubyMethod(name = "throw", module = true, visibility = PRIVATE, compat = CompatVersion.RUBY1_9)
