 ...
 * http://www.eclipse.org/legal/epl-v10.html Software distributed under the
 * License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND,
 * either express or implied. See the License for the specific language
 * governing rights and limitations under the License. Copyright (C) 2001 Chad
 * Fowler <chadfowler@chadfowler.com> Copyright (C) 2001 Alan Moore
 * <alan_moore@gmx.net> Copyright (C) 2001-2002 Benoit Cerrina
 * <b.cerrina@wanadoo.fr> Copyright (C) 2001-2004 Jan Arne Petersen
 * <jpetersen@uni-bonn.de> Copyright (C) 2002-2004 Anders Bengtsson
 * <ndrsbngtssn@yahoo.se> Copyright (C) 2004 Thomas E Enebo <enebo@acm.org>
 * Copyright (C) 2004-2005 Charles O Nutter <headius@headius.com> Copyright (C)
 * 2004 Stefan Matthias Aust <sma@3plus4.de> Copyright (C) 2006-2007 Miguel
 * Covarrubias <mlcovarrubias@gmail.com> Copyright (C) 2007 William N Dortch
 * <bill.dortch@gmail.com> Alternatively, the contents of this file may be used
 ...
 * allow others to use your version of this file under the terms of the EPL,
 * indicate your decision by deleting the provisions above and replace them with
 * the notice and other provisions required by the GPL or the LGPL. If you do
 * not delete the provisions above, a recipient may use your version of this
 * file under the terms of any one of the EPL, the GPL or the LGPL.**** END
 * LICENSE BLOCK ****
 */
package org.jruby;
...
import org.jruby.parlib.ComTableItem;
...
public class RubyModule extends RubyObject {
    ...
    public static final Set<String> SCOPE_CAPTURING_METHODS = new HashSet<String>(Arrays.asList(
            "eval", "module_eval", "class_eval", "instance_eval", "module_exec", "class_exec",
            "instance_exec", "binding", "local_variables"));
    ...
    public void checkValidBindTargetFrom(ThreadContext context, RubyModule originModule)
            throws RaiseException {
        if (!this.hasModuleInHierarchy(originModule)) {
            if (originModule instanceof MetaClass) {
                throw context.runtime
                        .newTypeError("can't bind singleton method to a different class");
            } else {
                throw context.runtime.newTypeError("bind argument must be an instance of "
                        + originModule.getName());
            }
        }
    }
    ...
    public static class ModuleKernelMethods {
        ...
        public static IRubyObject autoload_p(ThreadContext context, IRubyObject recv,
                IRubyObject arg0) {
    ...
    public synchronized Map<String, ConstantEntry> getConstantMapForWrite() {
        return constants == Collections.EMPTY_MAP ? constants = new ConcurrentHashMap<String, ConstantEntry>(
                4, 0.9f, 1) : constants;
    }

    /**
     * AutoloadMap must be accessed after checking ConstantMap. Checking UNDEF
     * value in constantMap works as a guard. For looking up constant, check
     * constantMap first then try to get an Autoload object from autoloadMap.
     * For setting constant, update constantMap first and remove an Autoload
     * object from autoloadMap.
     */
    ...
    private synchronized Map<String, Autoload> getAutoloadMapForWrite() {
        return autoloads == Collections.EMPTY_MAP ? autoloads = new ConcurrentHashMap<String, Autoload>(
                4, 0.9f, 1) : autoloads;
    }
    ...
    public synchronized Map<String, DynamicMethod> getMethodsForWrite() {
        ...
        return myMethods == Collections.EMPTY_MAP ? this.methods = new ConcurrentHashMap<String, DynamicMethod>(
                0, 0.9f, 1) : myMethods;
    }
    ...
    /**
     * Is this module one that in an included one (e.g. an
    ...
    /**
     * Generate a fully-qualified class name or a #-style name for anonymous and
     * singleton classes. Ruby C equivalent = "classname"
     * 
    ...
    private String calculateName() {
        ...
        int i = parentCount - 1;
        int totalLength = name.length() + parentCount * 2; // name length +
// enough :: for all parents
        for (RubyModule p = getParent(); p != null && p != objectClass; p = p.getParent(), i--) {
            ...
            // Marshalling, among others. The correct thing to do in this
// situation
    ...
    private String calculateAnonymousName() {
        if (anonymousName == null) {
            ...
            StringBuilder anonBase = new StringBuilder("#<" + metaClass.getRealClass().getName()
                    + ":0x");
    ...
    public IncludedModuleWrapper newIncludeClass(RubyClass superClazz) {
        IncludedModuleWrapper includedModule = new IncludedModuleWrapper(getRuntime(), superClazz,
                this);
    ...
    public synchronized void includeModule(IRubyObject arg) {
        ...
        if (!(arg instanceof RubyModule)) {
            throw getRuntime().newTypeError(
                    "Wrong argument type " + arg.getMetaClass().getName() + " (expected Module).");
        }
...
// methods for each call
        ...
        if (!foundMethod) {
            throw new RuntimeException("No JRubyMethod present for method " + name + "on class "
                    + clazz.getName());
        }
    }
    ...
    public static class MethodClumper {
        ...
        public void clump(Class cls) {
            ...
            for (Method method : declaredMethods) {
                ...
                // skip bridge methods, as generated by JDK8 javac for
// return-value overloaded methods
                if (method.isBridge())
                    continue;
    ...
    public void defineAnnotatedMethodsIndividually(Class clazz) {
        ...
        if (RubyInstanceConfig.FULL_TRACE_ENABLED || RubyInstanceConfig.REFLECTED_HANDLES) {
            // we want reflected invokers or need full traces, use default
// (slow) populator
            if (DEBUG)
                LOG.info("trace mode, using default populator");
            populator = TypePopulator.DEFAULT;
        } else {
            try {
                String qualifiedName = "org.jruby.gen."
                        + clazz.getCanonicalName().replace('.', '$');

                if (DEBUG)
                    LOG.info("looking for " + qualifiedName + AnnotationBinder.POPULATOR_SUFFIX);

                Class populatorClass = Class.forName(qualifiedName
                        + AnnotationBinder.POPULATOR_SUFFIX);
                populator = (TypePopulator) populatorClass.newInstance();
            } catch (Throwable t) {
                if (DEBUG)
                    LOG.info("Could not find it, using default populator");
                populator = TypePopulator.DEFAULT;
            }
        }
    ...
    public boolean defineAnnotatedMethod(String name, JavaMethodDescriptor desc,
            MethodFactory methodFactory) {
    ...
    public void undef(ThreadContext context, String name) {
        ...
        if (name.equals("__id__") || name.equals("__send__")) {
            runtime.getWarnings().warn(ID.UNDEFINING_BAD,
                    "undefining `" + name + "' may cause serious problem");
        }
        ...
        if (method.isUndefined()) {
            ...
            throw runtime.newNameError(
                    "Undefined method " + name + " for" + s0 + " '" + c.getName() + "'", name);
        }
        addMethod(name, UndefinedMethod.getInstance());
    ...
    public IRubyObject include_p(ThreadContext context, IRubyObject arg) {
        ...
        // See if module is in chain...Cannot match against itself so start at
// superClass.
    ...
    public void addMethodAtBootTimeOnly(String name, DynamicMethod method) {
        /**
         * added by Weixing Ji for commutative testing
         */
        //FIXME: why does this statement lead to a boot failure?
        //method.setName(name);
        /*************************************************/
    ...
    public void removeMethod(ThreadContext context, String name) {
        ...
        // We can safely reference methods here instead of doing getMethods()
// since if we
        // are adding we are not using a IncludedModuleWrapper.
        synchronized (getMethodsForWrite()) {
            DynamicMethod method = (DynamicMethod) getMethodsForWrite().remove(name);
            if (method == null) {
                throw runtime.newNameError("method '" + name + "' not defined in " + getName(),
                        name);
            }
    ...
    /**
     * Search through this module and supermodules for method definitions. Cache
     * superclass definitions in this class.
     * 
     * @param name
    ...
    public CacheEntry searchWithCache(String name) {
        ...
        // we grab serial number first; the worst that will happen is we cache a
// later
        ...
        return method != null ? addToCache(name, method, token) : addToCache(name,
                UndefinedMethod.getInstance(), token);
    }
    ...
    private final Map<String, CacheEntry> getCachedMethodsForWrite() {
        ...
        return myCachedMethods == Collections.EMPTY_MAP ? this.cachedMethods = new ConcurrentHashMap<String, CacheEntry>(
                0, 0.75f, 1) : myCachedMethods;
    }
    ...
    protected static abstract class CacheEntryFactory {
        ...
        /**
         * Test all WrapperCacheEntryFactory instances in the chain for
         * assignability from the given class.
         * 
         * @param cacheEntryFactoryClass
         *            the class from which to test assignability
         * @return whether the given class is assignable from any factory in the
         *         chain
         */
    ...
    /**
     * A wrapper CacheEntryFactory, for delegating cache entry creation along a
     * chain.
     */
    protected static abstract class WrapperCacheEntryFactory extends CacheEntryFactory {
        ...
        /**
         * Construct a new WrapperCacheEntryFactory using the given
         * CacheEntryFactory as the "previous" wrapped factory.
         * 
         * @param previous
         *            the wrapped factory
         */
    ...
    // modifies this class only; used to make the Synchronized module
// synchronized
    ...
    /**
     * Find the given class in this hierarchy, considering modules along the
     * way.
     * 
     * @param clazz
     *            the class to find
    ...
    private DynamicMethod searchForAliasMethod(Ruby runtime, String name) {
        // JRUBY-2435: Aliasing eval and other "special" methods should display
// a warning
        // We warn because we treat certain method names as "special" for
// purposes of
        // optimization. Hopefully this will be enough to convince people not to
// alias
        // them.
    ...
    public RubyClass defineOrGetClassUnder(String name, RubyClass superClazz) {
        ...
        // the Object allocator. It should NOT be used to define classes that
// require a native allocator.
        ...
        if (classObj != null) {
            ...
            if (superClazz != null) {
                ...
                while (tmp != null && tmp.isIncluded())
                    tmp = tmp.getSuperClass(); // need to skip
// IncludedModuleWrappers
                if (tmp != null)
        ...
        } else if (classProviders != null
                && (clazz = searchProvidersForClass(name, superClazz)) != null) {
            // reopen a java class
        } else {
            if (superClazz == null)
    ...
    /**
     * rb_define_class_under this method should be used only as an API to
     * define/open nested classes
     */
    ...
    /**
     * rb_define_module_under this method should be used only as an API to
     * define/open nested module
     */
    public RubyModule defineModuleUnder(String name) {
        return getRuntime().defineModuleUnder(name, this);
    }

    private void addAccessor(ThreadContext context, String internedName, Visibility visibility,
        ...
        if (readable) {
            addMethod(internedName, new AttrReaderMethod(this, visibility,
                    CallConfiguration.FrameNoneScopeNone, variableName));
            callMethod(context, "method_added", runtime.fastNewSymbol(internedName));
        }
        if (writeable) {
            internedName = (internedName + "=").intern();
            addMethod(internedName, new AttrWriterMethod(this, visibility,
                    CallConfiguration.FrameNoneScopeNone, variableName));
            callMethod(context, "method_added", runtime.fastNewSymbol(internedName));
        }
    }
    ...
    public void exportMethod(String name, Visibility visibility) {
        ...
        if (method.getVisibility() != visibility) {
            if (this == method.getImplementationClass()) {
                ...
                // FIXME: Why was this using a FullFunctionCallbackMethod before
// that did callSuper?
    ...
    public boolean isMethodBound(String name, boolean checkVisibility, boolean checkRespondTo) {
        if (!checkRespondTo)
            return isMethodBound(name, checkVisibility);
        DynamicMethod method = searchMethod(name);
    ...
    public IRubyObject newMethod(IRubyObject receiver, String methodName, boolean bound,
            Visibility visibility) {
        return newMethod(receiver, methodName, bound, visibility, false, true);
    }

    public IRubyObject newMethod(IRubyObject receiver, final String methodName, boolean bound,
            Visibility visibility, boolean respondToMissing) {
    ...
    public IRubyObject newMethod(IRubyObject receiver, final String methodName, boolean bound,
            ...
            if (respondToMissing) { // 1.9 behavior
                if (receiver.respondsToMissing(methodName, priv)) {
                    ...
                    throw getRuntime().newNameError(
                            "undefined method `" + methodName + "' for class `" + this.getName()
                                    + "'", methodName);
                }
            } else {
                throw getRuntime().newNameError(
        ...
        if (bound) {
            newMethod = RubyMethod.newMethod(implementationModule, methodName, originModule,
                    methodName, method, receiver);
        } else {
            newMethod = RubyUnboundMethod.newUnboundMethod(implementationModule, methodName,
                    originModule, methodName, method);
        }
    ...
    public IRubyObject define_method(ThreadContext context, IRubyObject arg0, Block block) {
        ...
        // We need our identifier to be retrievable and creatable as a symbol.
// This side-effect
        // populates this name into our symbol table so it will exist later if
// needed. The
        // reason for this hack/side-effect is that symbols store their values
// as raw bytes. We lose encoding
        // info so we need to make an entry so any accesses with raw bytes later
// gets proper symbol.
        ...
        // a normal block passed to define_method changes to do arity checking;
// make it a lambda
    ...
    @JRubyMethod(name = "define_method", visibility = PRIVATE, reads = VISIBILITY)
    public IRubyObject define_method(ThreadContext context, IRubyObject arg0, IRubyObject arg1,
            Block block) {
        Ruby runtime = context.runtime;
        IRubyObject body;
        String name = TypeConverter.convertToIdentifier(arg0);
...
// gets proper symbol.
        ...
        if (runtime.getProc().isInstance(arg1)) {
            // double-testing args.length here, but it avoids duplicating the
// proc-setup code in two places
            ...
            throw runtime.newTypeError("wrong argument type " + arg1.getType().getName()
    ...
    public IRubyObject define_method(ThreadContext context, IRubyObject[] args, Block block) {
        ...
        default:
            throw context.runtime.newArgumentError("wrong number of arguments (" + args.length
                    + " for 2)");
        }
    }
    ...
    private DynamicMethod createProcMethod(String name, Visibility visibility, RubyProc proc) {
        ...
        // for zsupers in define_method (blech!) we tell the proc scope to act
// as the "argument" scope
        scope.makeArgumentScope();

        Arity arity = block.arity();
        // just using required is broken...but no more broken than before zsuper
// refactoring
    ...
    public IRubyObject executeUnder(ThreadContext context,
            org.jruby.runtime.callback.Callback method, IRubyObject[] args, Block block) {
    ...
    // DPR added for commutative table annotations
    // New member variables
    // cTable stores the commutativity relationships for methods
    // Methods are represented as their serial numbers
    private volatile Map<Long, Map<Long, ComTableItem>> cTable;
    private boolean hasACOp = false;
    private boolean simpleCTable = true;
    // Simple commutative method list.
    // cList helps fast path for simple commutative methods
    private ArrayList<DynamicMethod> cList = null;

    /**
     * Add commutative table item, called internally
     * 
     * @param method1
     * @param method2
     * @param itemType
     * @param content
     */
    private void addCTableItem(DynamicMethod method1, DynamicMethod method2, int itemType,
            Object content) {
        if (itemType == ComTableItem.COM_TABLE_TYPE_BOOL) {
            // if the itemType is simple, we can put the method in a module's
            // commutative method list (cList), and assign an index to the
            // method.
            // Lazily initialize cList
            if (this.cList == null) {
                this.cList = new ArrayList<DynamicMethod>();
            }
        }

        // For slow path, add the method into cTable
        ComTableItem myItem = new ComTableItem(itemType, content);
        // Lazy initialization for ctable
        if (this.cTable == null) {
            this.cTable = new ConcurrentHashMap<Long, Map<Long, ComTableItem>>();
            this.hasACOp = true;
            // Initially we set the ctable to be simple
            this.simpleCTable = true;
        }
        // Query for the first method's row
        Map<Long, ComTableItem> rowFirstMethod = this.cTable.get(method1.getSerialNumber());
        // Lazily initialize and add first method's row if it's not there
        if (rowFirstMethod == null) {
            rowFirstMethod = new ConcurrentHashMap<Long, ComTableItem>();
            this.cTable.put(method1.getSerialNumber(), rowFirstMethod);
        }
        rowFirstMethod.put(method2.getSerialNumber(), myItem);
        if (itemType != ComTableItem.COM_TABLE_TYPE_BOOL) {
            this.simpleCTable = false;
        }
    }

    /**
     * Set two methods to be commutative, called by the predefined setCommute
     * method.
     * 
     * @param method1
     * @param method2
     ...
     * @param content
     */
    public void setCommutative(DynamicMethod method1, DynamicMethod method2, int itemType,
            Object content) {
        addCTableItem(method1, method2, itemType, content);
        // Make sure the table is symmetric
        if (method1.getSerialNumber() != method2.getSerialNumber()) {
            addCTableItem(method2, method1, itemType, content);
        }
        // Make sure both methods are marked as annotated
        if (!method1.isCommutativeAnnotated()) {
            method1.annotateACOpCommutativity();
        }
        // Make sure both methods are marked as annotated
        if (!method2.isCommutativeAnnotated()) {
            method2.annotateACOpCommutativity();
        }
    }

    public void setCommutative(String methodName1, String methodName2, int itemType, Object content) {
        DynamicMethod method1 = this.searchMethod(methodName1);
        if (method1.isUndefined()) {
            System.out.println("Parameter 1 of set commutative undefined");
            return;
        }
        DynamicMethod method2 = this.searchMethod(methodName2);
        if (method2.isUndefined()) {
            System.out.println("Parameter 1 of set commutative undefined");
            return;
        }
        this.setCommutative(method1, method2, itemType, content);
    }

    /**
     * Set a group of methods to be commutative, called by the built-in class.
     * 
     * @param methodNames
     *            : a group of methods
     * @param itemType
     * @param content
     * @param self
     *            : each method is commute with itself(true)
     */
    public void setCommutative(String[] methodNames, int itemType, Object content, boolean self) {
        for (int i = 0; i < methodNames.length; i++) {
            if (self) {
                setCommutative(methodNames[i], methodNames[i], itemType, content);
            }
            for (int j = i + 1; j < methodNames.length; j++) {
                setCommutative(methodNames[i], methodNames[j], itemType, content);
            }
        }
    }

    /**
     * Set two methods to be commutative, but only set method1's annotation to
     * yes. Used to control the side effect of method annotations
     * 
     * @param method1
     * @param method2
     * @param itemType
     * @param content
     */
    public void setSingleDiectionCommutative(DynamicMethod method1, DynamicMethod method2,
            int itemType, Object content) {
        addCTableItem(method1, method2, itemType, content);
        // Make sure the table is symmetric
        if (method1.getSerialNumber() != method2.getSerialNumber()) {
            addCTableItem(method2, method1, itemType, content);
    ...
    /**
     * Check whether two method calls are commutative, by querying the slow
     * commutative table. Called internally. Reserve interface for arguments and
     * return values. Note: this method is used for method calls with zero or
     * one argument
     * 
     * @param method1
     * @param method2
     ...
     * @param result1
     * @param isFallenBack
     *            : whether the method is called by a recursion to search parent
     *            classes
     * @return method1 is annotated as commutative with method2
     */
    private boolean commutesWith(DynamicMethod method1, DynamicMethod method2, IRubyObject arg0,
            IRubyObject arg1, IRubyObject result0, IRubyObject result1, boolean isFallenBack) {
        long serial1 = method1.getSerialNumber();
        long serial2 = method2.getSerialNumber();
        // If the ctable of this class is null, this class may not be annotated
        // If so, return true since we have already instrumented all calls
        // TODO: When a class is not annotated, how about asArgument's
        // commutativity with other methods?
        if (this.cTable == null && !this.hasACOp && !isFallenBack) {
            // System.out.println("cTable null on a un-annotated object");
            return true;
        } else if (this.cTable == null && !this.hasACOp) {
            // We failed in a fall back search, so we should return false
            return false;
        }
        // if(this.cTable.get(serial1) == null) System.out.println("map null");
        Map<Long, ComTableItem> rowFirstMethod = this.cTable.get(serial1);
        // If the relationship is not in my table, search in my parent's table
        if (rowFirstMethod == null) {
            if (this.parent != null) {
                return this.parent.commutesWith(method1, method2, arg0, arg1, result0, result1,
                        true);
            } else {
                return false;
            }
        }
        ComTableItem result = rowFirstMethod.get(serial2);
        if (result == null) {
            if (this.parent != null) {
                return this.parent.commutesWith(method1, method2, arg0, arg1, result0, result1,
                        true);
            ...
            return result.evaluate(arg0, arg1, result0, result1);
        }
    }
     ...
     * Check whether two method calls are commutative, by querying the slow
     * commutative table. Called internally. Reserve interface for arguments and
     * return values. Note: this method is used for method calls with multiple
     * arguments
     * 
     * @param method1
     * @param method2
     ...
     * @return method1 is annotated as commutative with method2
     */
    private boolean commutesWith(DynamicMethod method1, DynamicMethod method2, IRubyObject[] args0,
            IRubyObject[] args1, IRubyObject result0, IRubyObject result1, boolean isFallenBack) {
        long serial1 = method1.getSerialNumber();
        long serial2 = method2.getSerialNumber();
        // If the ctable of this class is null, this class may not be annotated
        // If so, return true since we have already instrumented all calls
        ...
        if (rowFirstMethod == null) {
            if (this.parent != null) {
                return this.parent.commutesWith(method1, method2, args0, args1, result0, result1,
                        true);
            } else {
                return false;
            }
        ...
        if (result == null) {
            ...
            return result.evaluate(args0, args1, result0, result1);
        }
    }

    /**
     * Public interface to check whether two method calls are commutative
     * 
     * @param method1
     * @param method2
     * @param arg0/1: for 0-1 arguments, args0/1: for multiple arguments
     * @param result0
     * @param result1
     * @return
     */
    public boolean isCommutative(DynamicMethod method1, DynamicMethod method2, IRubyObject arg0,
            IRubyObject arg1, IRubyObject result0, IRubyObject result1) {
        return this.commutesWith(method1, method2, arg0, arg1, result0, result1, false);
    }

    public boolean isCommutative(DynamicMethod method1, DynamicMethod method2) {
        boolean result = this.commutesWith(method1, method2, (IRubyObject) null, (IRubyObject) null, null,
                null, false);
        return result;
    }

    public boolean isCommutative(DynamicMethod method1, DynamicMethod method2, IRubyObject[] args0,
            IRubyObject[] args1, IRubyObject result0, IRubyObject result1) {
        return this.commutesWith(method1, method2, args0, args1, result0, result1, false);
    }

    /**
     * Check if the current module, as well as all of its parent modules, is
     * simple commutative table that only contains boolean values
     * 
     * @return whether the module and all of its parent modules are simple
     */
    public boolean isSimpleTable() {
        if (!this.simpleCTable) {
            return false;
        } else {
            if (this.parent != null) {
                return this.simpleCTable && this.parent.isSimpleTable();
            } else {
                return this.simpleCTable;
            }
        }
    }
    /**
     * Checks if the RubyModule contains any annotated ACOp
     * 
     * @return whether the module contains any method that is an ACOp
     */
    public boolean containsACOp() {
        if (this.parent == null) {
            return this.hasACOp;
        } else {
            return this.hasACOp || this.parent.containsACOp();
        }
    }

    // Interfaces for DPR programs
    // For unchecked annotations
    @JRubyMethod(name = "unchecked", required = 1, rest = true, visibility = PROTECTED)
    public RubyModule rbUnchecked(ThreadContext context, IRubyObject[] args) {
        for (int i = 0; i < args.length; i++) {
            IRubyObject currSymbol = args[i];
            String name = currSymbol.asJavaString();
            DynamicMethod method = searchMethod(name);
            if (method.isUndefined()) {
                System.out.println(name + " is undefined for uncheck");
            } else {
                method.annotateUnchecked();
            }
        }
        return this;
    }

    // For ACOp annotations, mark a groups of acops to be commutative with each other
    @JRubyMethod(name = "setACOps", required = 1, rest = true, visibility = PROTECTED)
    public RubyModule rbCommute(ThreadContext context, IRubyObject[] args) {
        // Firstly, call selfCommute for each method in args
        selfCommute(context, args);
        // If only one method is in args, simply return
        if (args.length == 1) {
            return this;
        }
        DynamicMethod[] dlist = new DynamicMethod[args.length];
        // Check and convert type
        for (int i = 0; i < args.length; i++) {
            IRubyObject currSymbol = args[i];
            String name = currSymbol.asJavaString();
            // System.out.println("Trying to find method " + name);
            DynamicMethod method = searchMethod(name);
            if (method.isUndefined()) {
                System.out.println("Undefined!");
            } else {
                // Store the method prototype down
                dlist[i] = method;
            }
        }
...
// System.out.println("Adding method pair "
// + ((IRubyObject)args[i]).asJavaString() + " "
// + ((IRubyObject)args[j]).asJavaString());
                this.setCommutative(dlist[i], dlist[j], ComTableItem.COM_TABLE_TYPE_BOOL, true);
            }
        }
        // System.out.println("setCommute called!");
        return this;
    }

    private RubyModule selfCommute(ThreadContext context, IRubyObject[] args) {
        for (int i = 0; i < args.length; i++) {
            IRubyObject currSymbol = args[i];
            String name = currSymbol.asJavaString();
// System.out
// .println("Trying to find self commutative method " + name);
            DynamicMethod method = searchMethod(name);
            if (method.isUndefined()) {
                System.out.println("Undefined!");
            } else {
                // Add the method as self commutative in ctable
                this.setCommutative(method, method, ComTableItem.COM_TABLE_TYPE_BOOL, true);
            }
            // System.out.println("selfCommute called! "+name);
        }

        return this;
    }
    
    // For ACOp annotations, mark a pair of ACOps to be a special case that are
    // not commutative.
    @JRubyMethod(name = "setNoCommute", required = 2, visibility = PROTECTED)
    public RubyModule rbDPRSetNoCommute(ThreadContext context, IRubyObject methodArg,
            IRubyObject methodArg1) {
        // Only two arguments
        String nameMethod = methodArg.asJavaString();
        String nameMethod1 = methodArg1.asJavaString();

        // Search to find the two methods
        DynamicMethod method = searchMethod(nameMethod);
        DynamicMethod method1 = searchMethod(nameMethod1);

        if (method.isUndefined() || method1.isUndefined()) {
            System.out
                    .println("At least one of the two methods in a setNoCommute call is undefined!");
        } else {
            // Set the two methods as not commutative in ctable
            this.setCommutative(method, method1, ComTableItem.COM_TABLE_TYPE_BOOL, false);
        }
        //System.out.println("noCommute called!");
        return this;
    }
    ...
    public boolean hasModuleInHierarchy(RubyModule type) {
        // XXX: This check previously used callMethod("==") to check for
// equality between classes
        // when scanning the hierarchy. However the == check may be safe; we
// should only ever have
        // one instance bound to a given type/constant. If it's found to be
// unsafe, examine ways
        // to avoid the == call.
        for (RubyModule module = this; module != null; module = module.getSuperClass()) {
    ...
    public IRubyObject to_s() {
        if (isSingleton()) {
            ...
            if (attached != null) { // FIXME: figure out why we get null
// sometimes
    ...
    /**
     * We override equals here to provide a faster path, since equality for
    ...
    public IRubyObject attr(ThreadContext context, IRubyObject[] args) {
        ...
        // Check the visibility of the previous frame, which will be the frame
// in which the class is being eval'ed
    ...
    public IRubyObject attr19(ThreadContext context, IRubyObject[] args) {
        ...
        if (args.length == 2 && (args[1] == runtime.getTrue() || args[1] == runtime.getFalse())) {
            runtime.getWarnings().warn(ID.OBSOLETE_ARGUMENT,
                    "optional boolean argument is obsoleted");
            addAccessor(context, args[0].asJavaString().intern(), context.getCurrentVisibility(),
                    args[0].isTrue(), true);
            return runtime.getNil();
        }
...
// in which the class is being eval'ed
    ...
    /**
     * rb_mod_attr_accessor Note: this method should not be called from Java in
     * most cases, since it depends on Ruby frame state for visibility. Use
     * add[Read/Write]Attribute instead.
     */
...
// in which the class is being eval'ed
        ...
        for (int i = 0; i < args.length; i++) {
            // This is almost always already interned, since it will be called
// with a symbol in most cases
            // but when created from Java code, we might get an argument that
// needs to be interned.
            // addAccessor has as a precondition that the string MUST be
// interned
    ...
    /**
     * Get a list of all instance methods names of the provided visibility
     * unless not is true, then get all methods which are not the provided
     * 
     * @param args
     *            passed into one of the Ruby instance_method methods
     * @param visibility
     *            to find matching instance methods against
     * @param not
     *            if true only find methods not matching supplied visibility
    ...
    private RubyArray instance_methods(IRubyObject[] args, final Visibility visibility,
            boolean not, boolean useSymbols) {
    ...
    public void populateInstanceMethodNames(Set<String> seen, RubyArray ary,
            final Visibility visibility, boolean not, boolean useSymbols, boolean includeSuper) {
        Ruby runtime = getRuntime();
            ...
            for (Map.Entry entry : type.getMethods().entrySet()) {
                ...
                if (!seen.contains(methodName)) {
                    ...
                    if (method.getImplementationClass() == realType
                            && (!not && method.getVisibility() == visibility || (not && method
                                    .getVisibility() != visibility)) && !method.isUndefined()) {

                        ary.append(useSymbols ? runtime.newSymbol(methodName) : runtime
    ...
    private void setVisibility(ThreadContext context, IRubyObject[] args, Visibility visibility) {
        if (args.length == 0) {
            // Note: we change current frames visibility here because the
// methods which call
            // this method are all "fast" (e.g. they do not created their own
// frame).
        ...
        if (args.length == 0) {
            ...
            for (int i = 0; i < args.length; i++) {
                ...
                getSingletonClass().addMethod(name,
                        new WrapperMethod(getSingletonClass(), method, PUBLIC));
    ...
    public RubyBoolean method_defined_p(ThreadContext context, IRubyObject symbol) {
        return isMethodBound(symbol.asJavaString(), true) ? context.runtime.getTrue()
    ...
    public IRubyObject public_method_defined(ThreadContext context, IRubyObject symbol) {
        ...
        return context.runtime
                .newBoolean(!method.isUndefined() && method.getVisibility() == PUBLIC);
    }
    ...
    public IRubyObject protected_method_defined(ThreadContext context, IRubyObject symbol) {
        ...
        return context.runtime.newBoolean(!method.isUndefined()
                && method.getVisibility() == PROTECTED);
    }
    ...
    public RubyModule alias_method(ThreadContext context, IRubyObject newId, IRubyObject oldId) {
        ...
        RubySymbol newSym = newId instanceof RubySymbol ? (RubySymbol) newId : context.runtime
                .newSymbol(newName);
        if (isSingleton()) {
    ...
    @JRubyMethod(name = { "module_eval", "class_eval" })
    public IRubyObject module_eval(ThreadContext context, IRubyObject arg0, IRubyObject arg1,
            Block block) {
    ...
    public static void marshalTo(RubyModule module, MarshalStream output)
    ...
    public static RubyArray nesting(ThreadContext context, IRubyObject recv, Block block) {
        ...
        for (StaticScope current = scope; current.getModule() != object; current = current
     ...
     * included twice, and selects an appropriate insertion point for each
     * incoming module.
     * 
     * @param baseModule
     *            The module to include, along with any modules it itself
     *            includes
     */
    private void doIncludeModule(RubyModule baseModule) {
        ...
        ModuleLoop: for (RubyModule nextModule : modulesToInclude) {
            ...
            for (RubyClass nextClass = this.getSuperClass(); nextClass != null; nextClass = nextClass
                    .getSuperClass()) {
                if (doesTheClassWrapTheModule(nextClass, nextModule)) {
                    // next in hierarchy is an included version of the module
// we're attempting,
                    // so we skip including it

                    // if we haven't encountered a real superclass, use the
// found module as the new inclusion point
                    if (!superclassSeen)
     ...
     * 
     * @param baseModule
     *            The base module from which to aggregate modules
     * @return A list of all modules that would be included by including the
     *         given module
     */
    ...
    /**
     * Actually proceed with including the specified module above the given
     * target in a hierarchy. Return the new module wrapper.
     * 
     * @param insertAbove
     *            The hierarchy target above which to include the wrapped module
     * @param moduleToInclude
     *            The module to wrap and include
    ...
    private RubyModule proceedWithInclude(RubyModule insertAbove, RubyModule moduleToInclude) {
        ...
        // IncludedModuleWrapper, so there's no need to fish out the delegate.
// But just
        // in case the logic should change later, let's do it anyway
        RubyClass wrapper = new IncludedModuleWrapper(getRuntime(), insertAbove.getSuperClass(),
                moduleToInclude.getNonIncludedClass());
        ...
        if (insertAbove instanceof RubyClass) {
            ...
            // if there's a non-null superclass, we're including into a normal
// class hierarchy;
            // update subclass relationships to avoid stale parent/child
// relationships
    ...
    public RubyBoolean const_defined_p(ThreadContext context, IRubyObject symbol) {
        ...
        return context.runtime.newBoolean(fastIsConstantDefined(validateConstant(
                symbol.asJavaString()).intern()));
    }
    ...
    public RubyBoolean const_defined_p19(ThreadContext context, IRubyObject[] args) {
        ...
        return context.runtime.newBoolean(fastIsConstantDefined19(
                validateConstant(symbol.asJavaString()).intern(), inherit));
    }
    ...
    public IRubyObject const_get_1_9(ThreadContext context, IRubyObject[] args) {
        ...
        // 1.9 only includes Object when inherit = true or unspecified
// (JRUBY-6224)
    ...
    public IRubyObject remove_const(ThreadContext context, IRubyObject rubyName) {
        ...
        throw context.runtime.newNameError("constant " + name + " not defined for " + getName(),
                name);
    }
    ...
    /**
     * Base implementation of Module#const_missing, throws NameError for
     * specific missing constant.
     * 
     * @param rubyName
     *            The constant name which was found to be missing
     * @return Nothing! Absolutely nothing! (though subclasses might choose to
     *         return something)
     */
    ...
    public RubyArray constantsCommon19(ThreadContext context, boolean replaceModule,
     ...
     * rb_mod_constants
     */
    public Collection<String> constantsCommon(Ruby runtime, boolean replaceModule,
            boolean allConstants) {
        return constantsCommon(runtime, replaceModule, allConstants, true);
    }

    public Collection<String> constantsCommon(Ruby runtime, boolean replaceModule,
            boolean allConstants, boolean includePrivate) {
        ...
        if (allConstants) {
            if ((replaceModule && runtime.getModule() == this) || objectClass == this) {
                ...
                Set<String> names = new HashSet<String>();
                for (RubyModule module = this; module != null && module != objectClass; module = module
                        .getSuperClass()) {
    ...
    private void setConstantVisibility(ThreadContext context, String name, boolean hidden) {
        ...
        if (entry == null) {
            throw context.runtime.newNameError("constant " + getName() + "::" + name
                    + " not defined", name);
        }
    ...
    /**
     * Set the named class variable to the given value, provided taint and
     * freeze allow setting it. Ruby C equivalent = "rb_cvar_set"
     * 
     * @param name
    ...
    /**
     * Retrieve the specified class variable, searching through this module,
     * included modules, and supermodules. Ruby C equivalent = "rb_cvar_get"
     * 
     * @param name
    ...
    public IRubyObject getClassVar(String name) {
        ...
        throw getRuntime().newNameError(
                "uninitialized class variable " + name + " in " + getName(), name);
    }
    ...
    public IRubyObject removeClassVariable(String name) {
        ...
        throw getRuntime().newNameError(
                "class variable " + javaName + " not defined for " + getName(), javaName);
    }
    ...
    /**
     * Retrieve the named constant, invoking 'const_missing' should that be
     * appropriate.
     * 
     * @param name
    ...
    public IRubyObject getConstantFromConstMissing(String name) {
        return callMethod(getRuntime().getCurrentContext(), "const_missing", getRuntime()
                .fastNewSymbol(name));
    }
    ...
    /**
     * Set the named constant on this module. Also, if the value provided is
     * another Module and that module has not yet been named, assign it the
     * specified name. This version does not warn if the constant has already
     * been set.
     * 
     * @param name
     *            The name to assign
     * @param value
     *            The value to assign to it; if an unnamed Module, also set its
     *            basename to name
    ...
    private IRubyObject setConstantCommon(String name, IRubyObject value, boolean warn) {
            ...
            if (oldValue == UNDEF) {
                ...
                if (warn) {
                    getRuntime().getWarnings().warn(ID.CONSTANT_ALREADY_INITIALIZED,
                            "already initialized constant " + name);
                }
        ...
        // if adding a module under a constant name, set that module's basename
// to the constant name
     ...
     * specified internal variable is found in this class/module
     * <em>or an ancestor</em>, it is set where found. Otherwise it is set in
     * this module.
     * 
     * @param name
     *            the internal variable name
    ...
    /**
     * Get the class variables for write. If it is not set or not of the right
     * size, synchronize against the object and prepare it accordingly.
     * 
    ...
    /**
     * Get the class variables for write. If it is not set or not of the right
     * size, atomically update it with an appropriate value.
     * 
     * @return the class vars map, ready for assignment
     */
    ...
    protected final String validateClassVariable(String name) {
        ...
        throw getRuntime().newNameError("`" + name + "' is not allowed as a class variable name",
                name);
    }
    ...
    public IRubyObject fetchConstant(String name, boolean includePrivate) {
        ...
        if (entry.hidden && !includePrivate) {
            throw getRuntime().newNameError(
                    "private constant " + getName() + "::" + name + " referenced", name);
        }
    ...
    // removes and returns the stored value without processing undefs
// (autoloads)
    ...
    protected final String validateConstant(String name) {
        if (getRuntime().is1_9() ? IdUtil.isValidConstantName19(name) : IdUtil
    ...
    /**
     * Define an autoload. ConstantMap holds UNDEF for the name as an autoload
     * marker.
     */
    ...
    /**
     * Extract an Object which is defined by autoload thread from autoloadMap
     * and define it as a constant.
     */
    ...
    /**
     * Get autoload constant. If it's first resolution for the constant, it
     * tries to require the defined feature and returns the defined value.
     * Multi-threaded accesses are blocked and processed sequentially except if
     * the caller is the autoloading thread.
     */
    ...
    /**
     * Removes an Autoload object from autoloadMap. ConstantMap must be updated
     * before calling this.
     */
    ...
    private static void define(RubyModule module, JavaMethodDescriptor desc, String simpleName,
    ...
    /**
     * The cached name, only cached once this class and all containing classes
     * are non-anonymous
     */
     ...
     * 'Module#autoload' creates this object and stores it in autoloadMap. This
     * object can be shared with multiple threads so take care to change
     * volatile and synchronized definitions.
     */
    private class Autoload {
        ...
        // Returns an object for the constant if the caller is the autoloading
// thread.
        // Otherwise, try to start autoloading and returns the defined object by
// autoload.
        ...
        // Update an object for the constant if the caller is the autoloading
// thread.
    ...
    /**
     * Get whether this Java proxy class should try to keep its instances
     * idempotent and alive using the ObjectProxyCache.
     */
    ...
    /**
     * Set whether this Java proxy class should try to keep its instances
     * idempotent and alive using the ObjectProxyCache.
     */
     ...
     *            the visitor to use
     * @param mod
     *            the module/class whose methods to visit
     */
    ...
    public void defineMethod(String name, org.jruby.runtime.callback.Callback method) {
        ...
        addMethod(name, new org.jruby.internal.runtime.methods.FullFunctionCallbackMethod(this,
                method, visibility));
    }
    ...
    public void defineFastMethod(String name, org.jruby.runtime.callback.Callback method) {
        Visibility visibility = name.equals("initialize") ? PRIVATE : PUBLIC;
        addMethod(name, new org.jruby.internal.runtime.methods.SimpleCallbackMethod(this, method,
                visibility));
    }
     ...
     */
    @Deprecated
    public void defineFastPublicModuleFunction(String name,
            org.jruby.runtime.callback.Callback method) {
    ...
    static {
        ...
        try {
            updater = AtomicReferenceFieldUpdater.newUpdater(RubyModule.class, Map.class,
                    "classVariables");
        } catch (RuntimeException re) {
            if (re.getCause() instanceof AccessControlException) {
                // security prevented creation; fall back on synchronized
// assignment
            } else {
                throw re;
            }
