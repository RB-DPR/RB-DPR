...
public class RubyObject extends RubyBasicObject {
    ...
    // Li Lu: Added a hypothetical method for every object
    // Hypothetical method for an object is used as an argument. This method
    // does not commute with any other methods except itself. 
    @JRubyMethod(name = "asArgument")
    public void asArgument() {
        // System.out.println("In asArgument");
    }
    
    // test data for read-only objects
    ...
    @JRubyMethod(name = "markReadOnly")
    public void markReadOnly() {
        System.out.println("Marked as read only!");
