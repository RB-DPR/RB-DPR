 ...
 */
public class LocalVarNode extends RefNode implements INameNode {
    ...
    //this is a flag for dynamic race detector, 
    //it is set by static analyzer, if this variable is accessed in a branch statement under dotall or cobegin
    private boolean dynTrack;
    ...
    public LocalVarNode(ISourcePosition position, int location, String name) {
		...
		this.dynTrack = false;
        this.setbInstrumented(true);

    }
    public void setDynTrack(boolean b){
    	this.dynTrack = b;
    }
    
    public boolean isDynTrack(){
    	return this.dynTrack;
    }
