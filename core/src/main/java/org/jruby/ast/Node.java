...
public abstract class Node implements ISourcePositionHolder {    
    ...
    //added by Weixing 2014-1-3
    private boolean isInBranch = false;
    private int nestedParallelContext = 0;
	...
	public void setInBranch(boolean isInBranch) {
		this.isInBranch = isInBranch;
	}

	public int getNestedParallelContext() {
		return nestedParallelContext;
	}

	public void setNestedParallelContext(int nestedParallelContext) {
		this.nestedParallelContext = nestedParallelContext;
	}
}
