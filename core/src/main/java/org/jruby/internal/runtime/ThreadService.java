...
public class ThreadService {
    ...
    /**
     * Added for DPR worker thread management
     */
    /**
     * ParLib thread manager
     *
     */
    private Scheduler parLibThreadMgr = null;
    
    public Scheduler getParLibThreadMgr() {
        return parLibThreadMgr;
    }
    
    public void setParLibThreadMgr(Scheduler mgr) {
        this.parLibThreadMgr = mgr;
    }
}
