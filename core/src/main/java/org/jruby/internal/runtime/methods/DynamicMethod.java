...
public abstract class DynamicMethod {
    ...
    // DPR added
    /** Whether the detector should instrument all accesses in this method */
    protected boolean shouldInstrument = true;
    /** Whether this method is a commutative method */
...
//                this instanceof );
    ...
    /**
     * Get the shouldInstrument bit for this method 
     */
    ...
    /**
     * Get commutative bit for this method
     */
    public boolean isCommutativeAnnotated() {
        // ACOps can be disabled by e-var ACOP
        if (RaceDetector.acopOn) {
    ...
    /**
     * We do need to instrument the method if the programmer annotated a method
     */
    public void annotateACOpCommutativity() {
        this.isCommutative = true;
    }
    
    /**
     * We do not need to instrument the method if the programmer mark this method as unchecked
     */
    public void annotateUnchecked() {
