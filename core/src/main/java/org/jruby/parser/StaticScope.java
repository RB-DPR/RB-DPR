...
public abstract class StaticScope implements Serializable {
    ...
    // Added by Weixing Ji, 2013-12-27
    // Read only variable
    private boolean[] variableReadOnly;
    // Instrumentation
    private boolean[] variableInstrumented;
    ...
    protected StaticScope(StaticScope enclosingScope, String[] names) {
        ...
        // Added by Weixing 2013-12-27
        this.variableReadOnly = new boolean[variableNames.length];
        this.variableInstrumented = new boolean[variableNames.length];
    }
    ...
    public StaticScope getEnclosingScope(int depth){
    	StaticScope result = this;
    	while(depth > 0){
    ...
    private void growVariableNames(String name) {
        ...
        // Added by Weixing 2013-12-27
        boolean[] newVariableReadOnly = new boolean[variableNames.length];
        boolean[] newVariableInstrumented = new boolean[variableNames.length];
        System.arraycopy(variableReadOnly, 0, newVariableReadOnly, 0, variableNames.length - 1);
        System.arraycopy(variableInstrumented, 0, newVariableInstrumented, 0, variableNames.length - 1);
        this.variableReadOnly = newVariableReadOnly;
        this.variableInstrumented = newVariableInstrumented;
    }
