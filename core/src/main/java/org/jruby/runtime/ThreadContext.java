...
public final class ThreadContext {
    ...
    public void setFileAndLine(String file, int line) {
        ...
        b.line = line;
        /** DPR added **/
        if (!RaceDetector.turnOff && RaceDetector.detailMode) {
            RaceDetector.setFileAndLine(file, line);
        }
        /** End **/
    }
    ...
    public void preCompiledClass(RubyModule type, StaticScope staticScope) {
        ...
        // Changed by DPR
        pushScope(DynamicScope.newDynamicScope(staticScope, getCurrentScope().getDepth()));
    }
