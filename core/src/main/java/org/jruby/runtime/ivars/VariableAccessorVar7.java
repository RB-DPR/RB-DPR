...
public class VariableAccessorVar7 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar7(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 7);
    }
    ...
    public Object get(Object object) {
        ...
        // DPR End
        return ((RubyObjectVar7)object).var7;
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ...
        // DPR End
        ((RubyObjectVar7)self).var7 = value;
    }
}
