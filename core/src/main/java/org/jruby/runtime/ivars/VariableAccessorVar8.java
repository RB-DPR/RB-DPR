...
public class VariableAccessorVar8 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar8(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 8);
    }
    ...
    public Object get(Object object) {
        ...
        // DPR End
        return ((RubyObjectVar8)object).var8;
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ...
        // DPR End
        ((RubyObjectVar8)self).var8 = value;
    }
}
